...
main (int argc, char **argv)
{
  ...
  for (size_t i = 0; i * speed < 1; i++) {
    ...
    forest =
      t8_forest_new_adapt (forest, t8_adapt_callback_coarse, 0, 0,
                           &adapt_data);
    forest =
      t8_forest_new_adapt (forest, t8_adapt_callback_coarse_all, 0, 0, NULL);
    forest =
      t8_forest_new_adapt (forest, t8_adapt_callback_coarse_all, 0, 0, NULL);
    ...
    forest =
      t8_forest_new_adapt (forest, t8_adapt_callback_refine_all, 0, 0, NULL);
    forest =
      t8_forest_new_adapt (forest, t8_adapt_callback_refine_all, 0, 0, NULL);
    forest =
      t8_forest_new_adapt (forest, t8_adapt_callback_refine, 0, 0,
                           &adapt_data);
    forest =
      t8_forest_new_adapt (forest, t8_adapt_callback_remove, 0, 0,
                           &adapt_data);
    if (i + 1 < 10) {
      prefix.pop_back ();
    }
